...
export class ValidationError {
  constructor(
    ...
    protected readonly planconfig: any,
    protected error: Error
  ) {}
}

export class PaymentConfigManagerShared {
  ...
  constructor(
    config: PaymentConfigManagerConfig,
  ...
  public async storeProductConfig(
    ...
    if (error) {
      throw new ValidationError('storeProductConfig', productConfig, error);
    }
  ...
  public async storePlanConfig(
    ...
    if (error) {
      throw new ValidationError('storePlanConfig', planConfig, error);
    }
